/*
  ...
  blur-md на самом фото, а не backdrop-blur на панелях сверху: как и на
  Summer Cherry, живой backdrop-filter над этим фиксированным фоном должен
  пересчитываться на каждый кадр прокрутки — на слабой видеокарте или при
  выключенном аппаратном ускорении это не просто тормозит, а иногда не
  ...
  полупрозрачные, без backdrop-filter.
*/
export default function SiteBackground({ photoUrl, inner = false }) {
  return (
    <>
      <div
        aria-hidden
        className="h-screen-stable fixed inset-x-0 top-0 -z-20 bg-linen bg-cover bg-no-repeat blur-md [transform:translateZ(0)] [-webkit-transform:translateZ(0)] [backface-visibility:hidden] [will-change:transform]"
        style={{
