...
export const T = {
  ru: {
    ...
    common: {
      ...
      health: 'Здоровье',
      ems: 'Код окраса',
      freeOf: (free, total) => `свободны ${free} из ${total}`,
    ...
    home: {
      ...
      midQuoteEyebrow: 'Место',
      midQuote: 'Питомник в Новороссийске, у моря — сосны, воздух и простор вместо тесных вольеров.',
      catsEyebrow: '02 — Наши коты',
  ...
  en: {
    ...
    common: {
      ...
      health: 'Health',
      ems: 'EMS code',
      freeOf: (free, total) => `${free} of ${total} available`,
    ...
    home: {
      ...
      midQuoteEyebrow: 'The place',
      midQuote: 'A cattery in Novorossiysk, by the sea — pines, fresh air and room to roam instead of cramped enclosures.',
      catsEyebrow: '02 — Our cats',
